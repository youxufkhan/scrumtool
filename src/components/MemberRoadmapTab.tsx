    ...
    <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* 30 Days Card */}
          <div className="p-5 rounded-2xl bg-slate-50/60 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col">
            <div className="flex items-center gap-2 text-xs font-bold text-indigo-600 dark:text-indigo-400 mb-3">
              ...
              <span>30 Days — Immediate Focus</span>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-slate-50/60 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col">
            <div className="flex items-center gap-2 text-xs font-bold text-purple-600 dark:text-purple-400 mb-3">
              ...
              <span>60 Days — Expanding Ownership</span>
            </div>
            <div className="flex-1 text-xs text-slate-700 dark:text-slate-300 whitespace-pre-wrap leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-slate-50/60 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col">
            <div className="flex items-center gap-2 text-xs font-bold text-emerald-600 dark:text-emerald-400 mb-3">
              ...
              <span>90 Days — Strategic Impact</span>
            </div>
            <div className="flex-1 text-xs text-slate-700 dark:text-slate-300 whitespace-pre-wrap leading-relaxed">
...
export default MemberRoadmapTab;
